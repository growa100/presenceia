    ...
    <LegalPage
      ...
      sections={[
        ...
        { title: 'Ne plus être contacté', body: [
          'Chaque email de prospection contient un lien de désinscription et vous pouvez répondre « stop ». Votre adresse est alors exclue de tout envoi futur, immédiatement et définitivement. Vous pouvez aussi écrire à antoine@presenceia.com.',
        ]},
        ...
        { title: 'Vos droits', body: [
          'Vous pouvez demander l\'accès à vos données, leur rectification, leur effacement, la limitation du traitement ou vous opposer au traitement, en écrivant à antoine@presenceia.com. Vous pouvez également saisir le Préposé fédéral à la protection des données et à la transparence (PFPDT) ou, dans l\'UE, l\'autorité de contrôle de votre pays.',
        ]},
      ]}
    />
  )
