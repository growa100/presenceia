...
const fr = {
  ...
  hero: {
    ...
    h1a: 'Votre entreprise apparaît-elle',
    h1b: 'dans les réponses de ChatGPT\u00a0?',
...
const de: typeof fr = {
  ...
  hero: {
    ...
    h1a: 'Erscheint Ihr Betrieb',
    h1b: 'in den Antworten von ChatGPT?',
...
const en: typeof fr = {
  ...
  hero: {
    ...
    h1a: 'Does your business show up',
    h1b: 'in ChatGPT’s answers?',
