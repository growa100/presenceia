...
const fr = {
  ...
  hero: {
    ...
    h1a: 'Quand vos clients demandent à l\'IA,',
    h1b: 'c\'est vous qu\'elle doit recommander.',
    sub: 'ChatGPT, Gemini, Claude et Perplexity deviennent le premier réflexe pour trouver un artisan, un restaurant ou une fiduciaire. Présence IA mesure ce que ces assistants disent de votre entreprise, puis vous rend visible et recommandé, sur les IA comme sur Google.',
...
const de: typeof fr = {
  ...
  hero: {
    ...
    h1a: 'Wenn Ihre Kunden die KI fragen,',
    h1b: 'sollte sie Sie empfehlen.',
    sub: 'ChatGPT, Gemini, Claude und Perplexity werden zum ersten Reflex, um einen Handwerker, ein Restaurant oder einen Treuhänder zu finden. Présence IA misst, was diese Assistenten über Ihren Betrieb sagen, und macht Sie sichtbar und empfohlen, bei der KI wie auf Google.',
...
const en: typeof fr = {
  ...
  hero: {
    ...
    h1a: 'When your customers ask AI,',
    h1b: 'it should recommend you.',
    sub: 'ChatGPT, Gemini, Claude and Perplexity are becoming the first reflex to find a tradesperson, a restaurant or an accountant. Présence IA measures what these assistants say about your business, then makes you visible and recommended, on AI and on Google.',
