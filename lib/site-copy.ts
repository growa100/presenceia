...
const fr = {
  nav: { examples: 'Exemples', how: 'Comment ça marche', pricing: 'Tarifs', faq: 'Questions', blog: 'Blog', login: 'Espace client', cta: 'Activer mon site' },
  hero: {
    eyebrow: 'Sites web pour artisans et PME · Suisse romande & France',
  ...
  included: {
    ...
    items: [
      ...
      { title: 'Votre nom de domaine', desc: 'www.votre-entreprise.ch (ou .fr) enregistré à votre nom, configuré pour vous.' },
  ...
  pricing: {
    ...
    sub: 'Mensuel, sans engagement, résiliable en tout temps. Prix en francs suisses ; en France, les mêmes offres en euros.',
    mo: '/ mois',
    ...
    plans: [
      ...
      { name: 'Site + Visibilité IA', price: 149, popular: true, desc: 'Pour être recommandé par ChatGPT et Google.', features: ['Tout le pack Site web, plus :', 'Structure lisible par les IA (ChatGPT, Perplexity, Gemini)', 'Fiche Google Business optimisée', 'Inscription aux annuaires suisses', 'Rapport mensuel de visibilité IA'], cta: 'Choisir cette offre' },
  ...
  founder: {
    ...
    text: 'Je suis valaisan. J\'ai lancé Présence IA parce que trop d\'artisans excellents ont un site qui ne leur ressemble pas, ou pas de site du tout, et que ce n\'est pas leur métier de s\'en occuper. Nous faisons le travail d\'abord, vous décidez ensuite. Je lis et je réponds moi-même à chaque email.',
  },
  faq: {
    ...
    items: [
      ...
      { q: 'Travaillez-vous en France et en Suisse alémanique ?', a: 'Oui. Suisse romande, Suisse alémanique (site en allemand) et France, avec un nom de domaine .ch ou .fr selon votre cas.' },
    ],
  },
  activate: {
  ...
  checker: {
    ...
    sub: 'Entrez votre entreprise, votre ville et votre métier. Résultat en 30 secondes.',
  },
  footer: {
...
const de: typeof fr = {
  nav: { examples: 'Beispiele', how: 'So funktioniert es', pricing: 'Preise', faq: 'Fragen', blog: 'Blog', login: 'Kundenbereich', cta: 'Website aktivieren' },
  hero: {
    eyebrow: 'Websites für Handwerker und KMU · Schweiz',
  ...
  included: {
    ...
    items: [
      ...
      { title: 'Ihre Domain', desc: 'www.ihre-firma.ch, auf Ihren Namen registriert und für Sie eingerichtet.' },
  ...
  pricing: {
    ...
    sub: 'Monatlich, ohne Vertragsbindung, jederzeit kündbar.',
    mo: '/ Monat',
  ...
  founder: {
    ...
    text: 'Ich komme aus dem Wallis. Ich habe Présence IA gegründet, weil zu viele ausgezeichnete Handwerker eine Website haben, die ihnen nicht gerecht wird, oder gar keine, und weil es nicht ihr Beruf ist, sich darum zu kümmern. Wir machen zuerst die Arbeit, Sie entscheiden danach. Jede E-Mail lese und beantworte ich selbst.',
  },
  faq: {
    ...
    items: [
      ...
      { q: 'Arbeiten Sie in der ganzen Schweiz?', a: 'Ja. Romandie, Deutschschweiz (Website auf Deutsch) und Frankreich, mit einer .ch- oder .fr-Domain je nach Fall.' },
    ],
  },
  activate: {
  ...
  checker: {
    ...
    sub: 'Geben Sie Betrieb, Ort und Beruf ein. Ergebnis in 30 Sekunden.',
  },
  footer: {
...
const en: typeof fr = {
  nav: { examples: 'Examples', how: 'How it works', pricing: 'Pricing', faq: 'FAQ', blog: 'Blog', login: 'Client area', cta: 'Activate my site' },
  hero: {
    eyebrow: 'Websites for trades and small businesses · Switzerland & France',
  ...
  included: {
    ...
    items: [
      ...
      { title: 'Your domain name', desc: 'www.your-business.ch (or .fr) registered in your name and set up for you.' },
  ...
  pricing: {
    ...
    sub: 'Monthly, no commitment, cancel anytime. Prices in Swiss francs; in France, the same plans in euros.',
    mo: '/ month',
    popular: 'Most chosen',
    plans: [
      ...
      { name: 'Website + AI visibility', price: 149, popular: true, desc: 'To be recommended by ChatGPT and Google.', features: ['Everything in Website, plus:', 'AI-readable structure (ChatGPT, Perplexity, Gemini)', 'Optimised Google Business profile', 'Listing in Swiss directories', 'Monthly AI visibility report'], cta: 'Choose this plan' },
  ...
  founder: {
    ...
    text: 'I am from Valais. I started Présence IA because too many excellent tradespeople have a website that does not do them justice, or none at all, and looking after one is not their job. We do the work first, you decide after. I read and answer every email myself.',
  },
  faq: {
    ...
    items: [
      ...
      { q: 'Do you work in France and German-speaking Switzerland?', a: 'Yes. French-speaking Switzerland, German-speaking Switzerland (site in German) and France, with a .ch or .fr domain depending on your case.' },
    ],
  },
  activate: {
  ...
  checker: {
    ...
    sub: 'Enter your business, town and trade. Result in 30 seconds.',
  },
  footer: {
